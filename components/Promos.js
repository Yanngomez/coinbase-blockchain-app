...
const Promos = () => {
  return (
    <Wrapper>
        ...
        <OfferCard>
            <Title>Build by Yann GOMEZ</Title>
            <Description>Tu connais pas encore</Description>
            <Placeholder />
            <Additional style={{ color: '#3773f5' }}>
                <a href= 'https://twitter.com/yann80841260'>Twitter</a>
                <a href= 'https://www.linkedin.com/in/yann-gomez-87735622a/'>Linkedin</a>
                </Additional>
        </OfferCard>
    </Wrapper>
  )
